...
require 'jsonEsperadoBorrarUnActor.php';
...
if(isset($parameters)){
	...
	if(JSONCorrectoBorrarActor($mensajeRecibido)){

		$actor = $mensajeRecibido["actorBorrar"];
		...
		if (isset ( $result ) && $result) { // Si pasa por este if, la query está está bien y se ha insertado correctamente
			...
			$arrMensaje["mensaje"] = "Actor borrado correctamente";
